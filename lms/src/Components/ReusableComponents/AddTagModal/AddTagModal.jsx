...
const AddTagModal = ({ isOpen, onClose, onAddFolder, heading, selectedSection }) => {
                            ...
                            {colorOptions.map((color, index) => (
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        setCustomColor(""); // Reset custom color when a predefined color is selected
                                    }}
                                >
                                    {selectedColor === color && (
