  ...
  const questionBanks = [
    {
      ...
      name: "Questionbank-1",
      questions: [
        { id: 1, question: "What is React?", answer: "React is a JavaScript library for building UIs.", type: "truefalse", marks: 1, owner: "Admin" },
        ...
        { id: 3, question: "What is Virtual DOM?", answer: "Virtual DOM is an in-memory representation of the real DOM elements.", type: "shortanswer", marks: 2, owner: "Admin" },
      ],
      sections: [
        {
          name: "QB-1 Tag 1",
          questions: [
            { id: 4, question: "What are React Hooks?", answer: "Hooks are functions that let you use state and lifecycle features in functional components.", type: "longanswer", marks: 5, owner: "Admin" },
    ...
    },
    {
      ...
      name: "Questionbank-2",
      questions: [
        { id: 1, question: "What is JavaScript?", answer: "JavaScript is a programming language for web development.", type: "shortanswer", marks: 2, owner: "Teacher1" },
            ...
            <div className="w-100 d-flex justify-content-center mt-2">
              <div className="dropdown-wrapper w-100" ref={sectionsDropdownRef}>
                ...
                >
                  ...
                  {/* {isSectionsDropdownOpen ? <ChevronUp size={18} /> : <ChevronDown size={18} />} */}
                </button>
